                ...
                <div class="bg-white shadow-lg rounded-lg">
                    <div class="md:flex ">
                        <div class="w-full p-4 px-5 py-5">
                            ...
                            <div class="relative pb-5"> <input type="text" name="mail" value="{{auth()->user()->email ?? ''}}"class="border rounded h-10 w-full focus:outline-none focus:border-green-200 px-2 mt-2 text-sm" placeholder="E-mail"> </div> <span class="text-green-700 font-semibold">Shipping/Billing Information</span>
