                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="members-gifted-pill" aria-expanded="true">
                                    <div class="media">
                                        <h4 class="card-title text-green-600">Members Gifted</h4>
                                    </div>
                                    <!-- Validation Errors -->
                                    ...
                                    <form action="{{route('gift.store')}}" method="POST" novalidate>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <label for="plan">Plan you wish to Gift Members</label>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <label for="type">Plan Type you wish to Gift Members</label>
                                            ...
                                            <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                <button type="submit" class="btn btn-primary mr-sm-1 mb-1 mb-sm-0">Send Gift</button>
